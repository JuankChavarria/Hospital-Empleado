...
namespace Hospital_Empleados.App_Code
{
    public class DatabaseHelper
    {
        ...
        /// Propósito: Permitir la conexión a la base de datos HOSPITAL<br />
        ...
        /// </summary>
        /// <returns>Cadena de conexión para HOSPITAL.</returns>
        private string GetConnectionString()
            ...
            {
                string logFilePath = @"D:\Error_HOSPITAL\database_errors.log";// Ubicación y nombre del archivo de log
